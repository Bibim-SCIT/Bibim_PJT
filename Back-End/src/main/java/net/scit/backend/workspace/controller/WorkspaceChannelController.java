...
public class WorkspaceChannelController {
     ...
     *
     * @param chRoleNumber 워크스페이스 채널 역할 번호
    ...
    public ResponseEntity<ResultDTO<List<WorkspaceChannelLoginStatusDTO>>> getLoginStatusByRole(
            @RequestParam Long chRoleNumber) {

        List<WorkspaceChannelLoginStatusDTO> statusList = workspaceChannelService.getLoginStatusByRole(chRoleNumber);
